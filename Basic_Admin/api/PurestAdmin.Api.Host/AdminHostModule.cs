    ...
    public class AdminHostModule : AbpModule
    {
        ...
        private void ConfigureSwaggerServices(ServiceConfigurationContext context)
        {
            context.Services.AddAbpSwaggerGen(options =>
            {
                ...
                //options.SwaggerDoc("mes", new OpenApiInfo { Title = "MES基础建构管理" });
                //options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "PurestAdmin.MES_Basic.xml"), true);
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/mes/swagger.json", "MES基础建构管理");
